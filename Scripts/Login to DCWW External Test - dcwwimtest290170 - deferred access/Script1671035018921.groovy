...
WebUI.click(findTestObject('Page_2.30.6rc3 (DbNode290170DCWW datb test)_485f31/a_Automated Tester'))

WebUI.click(findTestObject('Page_2.30.6rc3 (DbNode290170DCWW datb test)_485f31/Deferred access rights'))

WebUI.click(findTestObject('Page_2.30.6rc3 (DbNode290170DCWW datb test)_485f31/a_kinodb system administration'))

WebUI.setText(findTestObject('Page_2.30.6rc3 (DbNode290170DCWW datb test)_485f31/input_PIN code'), '666655830')

WebUI.click(findTestObject('Page_2.30.6rc3 (DbNode290170DCWW datb test)_485f31/button_Continue'))
